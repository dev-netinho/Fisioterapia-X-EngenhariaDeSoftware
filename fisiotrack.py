...
try:
    ...
    print("AVISO: Arquivos de som 'hit.wav' ou 'finish.wav' não encontrados.")
    sound_enabled = False
...
def reset_exercise():
    ...
    state = {
        ...
        "last_hit_time": time.time(), "game_over": False,
...
while True:
    ...
    if state["game_over"]:
        ...
        cv2.putText(canvas, f"Tempo Total: {state['total_time']:.2f} s", (screen_width//2 - 220, screen_height//2), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (255, 255, 255), 2)
